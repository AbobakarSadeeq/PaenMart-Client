...
@Component({
  selector: 'app-shipping-pending-orders-for-admin',
  templateUrl: './shipping-pending-orders-for-admin.component.html',
  styleUrls: ['./shipping-pending-orders-for-admin.component.css']
})
export class ShippingPendingOrdersForAdminComponent implements OnInit {
